...
export const tileRegistry: TileRegistry = {
  ...
  spike: defineTile({ id: 'spike', name: '尖刺（全）', category: 'hazard', collision: 'none', hazardous: true, interactive: false, tags: ['hazard', 'death', 'spike'], editor: { color: '#ef4444', glyph: '▲', label: '全', paletteOrder: 30 }, runtime: { kind: 'spike' } }),
  spikeTop: defineTile({ id: 'spikeTop', name: '尖刺（上）', category: 'hazard', collision: 'none', hazardous: true, interactive: false, tags: ['hazard', 'death', 'spike', 'partial'], hazardBox: { x: 0, y: 0, width: 1, height: 0.5 }, visualBox: { x: 0, y: 0, width: 1, height: 0.5 }, editor: { color: '#ef4444', glyph: '', label: '上', paletteOrder: 31 }, runtime: { kind: 'spikeTop' } }),
  spikeBottom: defineTile({ id: 'spikeBottom', name: '尖刺（下）', category: 'hazard', collision: 'none', hazardous: true, interactive: false, tags: ['hazard', 'death', 'spike', 'partial'], hazardBox: { x: 0, y: 0.5, width: 1, height: 0.5 }, visualBox: { x: 0, y: 0.5, width: 1, height: 0.5 }, editor: { color: '#ef4444', glyph: '', label: '下', paletteOrder: 32 }, runtime: { kind: 'spikeBottom' } }),
  spikeLeft: defineTile({ id: 'spikeLeft', name: '尖刺（左）', category: 'hazard', collision: 'none', hazardous: true, interactive: false, tags: ['hazard', 'death', 'spike', 'partial'], hazardBox: { x: 0, y: 0, width: 0.5, height: 1 }, visualBox: { x: 0, y: 0, width: 0.5, height: 1 }, editor: { color: '#ef4444', glyph: '', label: '左', paletteOrder: 33 }, runtime: { kind: 'spikeLeft' } }),
  spikeRight: defineTile({ id: 'spikeRight', name: '尖刺（右）', category: 'hazard', collision: 'none', hazardous: true, interactive: false, tags: ['hazard', 'death', 'spike', 'partial'], hazardBox: { x: 0.5, y: 0, width: 0.5, height: 1 }, visualBox: { x: 0.5, y: 0, width: 0.5, height: 1 }, editor: { color: '#ef4444', glyph: '', label: '右', paletteOrder: 34 }, runtime: { kind: 'spikeRight' } }),
  ...
  timedPlatform: defineTile({ id: 'timedPlatform', name: '定时平台', category: 'terrain', collision: 'solid', hazardous: false, interactive: true, tags: ['platform', 'timed', 'rhythm'], editor: { color: '#38bdf8', glyph: '▤', label: '定时平台', paletteOrder: 148 }, runtime: { kind: 'timedPlatform' } }),
  movingPlatform: defineTile({ id: 'movingPlatform', name: '移动平台', category: 'terrain', collision: 'solid', hazardous: false, interactive: true, tags: ['platform', 'moving', 'horizontal'], collisionBox: { x: 0, y: 0.5, width: 1, height: 0.5 }, visualBox: { x: 0, y: 0.5, width: 1, height: 0.5 }, editor: { color: '#14b8a6', glyph: '↔', label: '移动平台', paletteOrder: 149 }, runtime: { kind: 'movingPlatform' } }),
