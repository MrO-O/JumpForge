...
export const tileRegistry: TileRegistry = {
  ...
  halfBlockTop: defineTile({ id: 'halfBlockTop', name: '上半方块', category: 'terrain', collision: 'solid', hazardous: false, interactive: false, tags: ['platform', 'solid', 'partial', 'half'], collisionBox: { x: 0, y: 0, width: 1, height: 0.5 }, visualBox: { x: 0, y: 0, width: 1, height: 0.5 }, editor: { color: '#475569', glyph: '▀', label: '上半', paletteOrder: 160 }, runtime: { kind: 'halfBlockTop' } }),
  halfBlockBottom: defineTile({ id: 'halfBlockBottom', name: '下半方块', category: 'terrain', collision: 'solid', hazardous: false, interactive: false, tags: ['platform', 'solid', 'partial', 'half'], collisionBox: { x: 0, y: 0.5, width: 1, height: 0.5 }, visualBox: { x: 0, y: 0.5, width: 1, height: 0.5 }, editor: { color: '#475569', glyph: '▄', label: '下半', paletteOrder: 161 }, runtime: { kind: 'halfBlockBottom' } }),
  halfBlockLeft: defineTile({ id: 'halfBlockLeft', name: '左半方块', category: 'terrain', collision: 'solid', hazardous: false, interactive: false, tags: ['platform', 'solid', 'partial', 'half'], collisionBox: { x: 0, y: 0, width: 0.5, height: 1 }, visualBox: { x: 0, y: 0, width: 0.5, height: 1 }, editor: { color: '#475569', glyph: '▌', label: '左半', paletteOrder: 162 }, runtime: { kind: 'halfBlockLeft' } }),
  halfBlockRight: defineTile({ id: 'halfBlockRight', name: '右半方块', category: 'terrain', collision: 'solid', hazardous: false, interactive: false, tags: ['platform', 'solid', 'partial', 'half'], collisionBox: { x: 0.5, y: 0, width: 0.5, height: 1 }, visualBox: { x: 0.5, y: 0, width: 0.5, height: 1 }, editor: { color: '#475569', glyph: '▐', label: '右半', paletteOrder: 163 }, runtime: { kind: 'halfBlockRight' } }),
};
